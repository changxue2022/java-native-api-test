...
public class TestInsertParams extends BaseTestSuite {
    ...
    @Test(priority = 20, expectedExceptions = ClassCastException.class)
    ...
    @Test(priority = 30, expectedExceptions = IndexOutOfBoundsException.class)
    ...
    @Test(priority = 30) // 执行成功，但是可能没有效果
    ...
    @Test(priority = 30, expectedExceptions = ClassCastException.class)
    public void testInsertRecord_valuesErrorType() throws IoTDBConnectionException, StatementExecutionException {
        List<Object> v = new ArrayList<>(1);
        v.add("1a1b");
        session.insertRecord(device, 100L, measurements, dataTypes, v);
    }
    @Test(priority = 37, expectedExceptions = StatementExecutionException.class)
    ...
    @Test(priority = 37, expectedExceptions = IndexOutOfBoundsException.class)
